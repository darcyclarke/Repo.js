 ...
 */
!function(e,t,i){var n=1,s=!1,a=!1,l={get:function(e){var i=t.location.hash;if(i.length>0){var n=i.match(new RegExp(e+":{([a-zA-Z0-9,-]*)}"));if(n)return n[1].split(",")}return[]},set:function(e,i){var n,s=t.location.hash,a=e+":{"+i.join(",")+"}",l=s.indexOf(e+":{");return 0===i.length?this.remove(e):(n=-1!==l?s.replace(new RegExp("("+e+":{[a-zA-Z0-9,-]*})"),a):s.length>0?s+","+a:a,void(t.location.hash=n))},remove:function(e){t.location.hash=t.location.hash.replace(new RegExp("([,]?"+e+":{[a-zA-Z0-9,-]*}[,]?)"),"")}},r={numberRange:/^([0-9]+)-([0-9]+)$/,pageNumber:/-([0-9]+)$/,multilineBegin:/<span class="([\w-_][^"]+)">(?:.[^<]*(?!<\/span>)|)$/gi,multilineEnd:/(<span class="([\w-_][^"]+)">)?(?:.[^<]*)?(<\/span>)/gi};e.fn.vanGogh=function(h){function o(){if(s||a)setTimeout(o,100);else{if(v++,v>=10)return;if(h.source&&!f)return a=!0,void e.ajax({url:h.source,crossDomain:!0,dataType:"text",success:function(e){f=e},error:function(e,t){f="ERROR: "+t},complete:function(){a=!1,o()}});if(i=i||t.hljs,!i)return s=!0,void e.getScript(h.autoload,function(){s=!1,o()});u.filter("pre,code").each(function(){function t(t,i,n){var h=s.find(".vg-line");i&&(s.find(".vg-highlight").removeClass("vg-highlight"),l.remove(a),v=[]),t="array"===e.type(t)?t:[t],e.each(t,function(t,i){if(v.indexOf(i)<=-1)if(!isNaN(parseFloat(i,10))&&isFinite(i)&&(i=parseInt(i,10)),"string"===e.type(i)){var n=r.numberRange.exec(i);if(n){for(var l=n[1],o=n[2],c="",t=l;o>=t;t++)c+=",#"+a+"-"+t,v.push(t);h.filter(c.substring(1)).addClass("vg-highlight")}else s.find(".vg-line:contains("+i+")").each(function(){var t=e(this).addClass("vg-highlight");t.html(t.html().replace(i,'<span class="vg-highlight">'+i+"</span>"))}),v.push(i)}else{var g=a+"-"+this,f=h.filter("#"+g);f.length&&(f.addClass("vg-highlight"),v.push(i))}}),!n&&l.set(a,v)}var s=e(this).addClass("vg-container").attr("id",this.id||"vg-"+n++),a=this.id,o=s.find("code"),g=!1,u=!1,v=[];o.length||(o=s,g=!0),h.source&&f&&o.text(f);o.text();i.highlightBlock(o[0],h.tab);var d=o.html().split("\n"),m="",p="";if(g)g&&s.addClass("vg-code");else{var x={},b=0;e.each(d,function(e,t){var i=e+h.firstLine,n=a+"-"+i,s=t;if(h.numbers&&(m+='<a class="vg-number" rel="#'+n+'">'+i+"</a>"),x[b]){var l=r.multilineEnd.exec(t);l&&!l[1]?(s='<span class="'+x[b]+'">'+s,delete x[b],b--):s='<span class="'+x[b]+'">'+s+"</span>"}var o=r.multilineBegin.exec(t);o&&(b++,x[b]=o[1]),p+='<div class="vg-line" id="'+n+'">'+s+"</div>"}),p='<code class="vg-code">'+p+"</code>",h.numbers&&(p='<div class="vg-gutter">'+m+"</div>"+p),s.html(p),o=s.find("code"),s.find(".vg-number").click(function(i){var n=e(this),h=n.attr("rel"),o=s.find(h);if(o.hasClass("vg-highlight"))return o.removeClass("vg-highlight"),v.splice(v.indexOf(n.text()),1),l.set(a,v),u=!1,!1;var c=u;return u=parseInt(r.pageNumber.exec(h)[1],10),i.shiftKey&&u?t(u>c?c+"-"+u:u+"-"+c,!0):t(u,i.ctrlKey?!1:!0),!1});var L=s.find(".vg-gutter"),R=L.outerWidth(),y=0,C=!1;h.animateGutter&&s.scroll(function(){if(this.scrollLeft!==y)if(this.scrollLeft>R){if(this.scrollLeft<y)y=this.scrollLeft,L.hide();else if(this.scrollLeft!==y){if(C)return;var e=this;y=this.scrollLeft,C=setTimeout(function(){C=!1;var t=e.scrollLeft;o.css("marginLeft",R),L.css({"float":"none",position:"absolute",left:t-R}).show().stop().animate({left:t})},500)}}else y=this.scrollLeft,clearTimeout(C),C=!1,L.css({"float":"",position:"",left:""}).show()})}if(o.dblclick(function(){return c(o[0]),!1}),h.maxLines>0){var T=s.find(".vg-line").height(),w=parseInt(o.css("paddingTop")),j=T*(h.maxLines+1)+w;s.css({minHeight:T+w,maxHeight:j})}h.highlight&&t(h.highlight,!0,!0);var E=l.get(a);E.length&&t(E,!1,!0)})}}function c(e){var i=t,n=t.document;if(n.body.createTextRange){var s=n.body.createTextRange();s.moveToElementText(e),s.select()}else if(n.createRange){var a=i.getSelection(),s=n.createRange();s.selectNodeContents(e),a.removeAllRanges(),a.addRange(s)}}var g={language:"auto",firstLine:1,maxLines:0,numbers:!0,highlight:null,animateGutter:!0,autoload:"http://softwaremaniacs.org/media/soft/highlight/highlight.pack.js",tab:"    "};h=e.extend({},g,h);var f,u=this,v=0;return o(),u}}(jQuery,this,"undefined"!=typeof this.hljs?this.hljs:!1);
/*!
 * Repo.js
 * @author Darcy Clarke
 *
